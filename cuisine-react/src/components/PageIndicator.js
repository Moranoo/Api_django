        ...
        <>
            <div className="pagination flex flex-col items-center gap-4 my-7">
                <div className="flex justify-center gap-4">
                    {prevPage &&
                        <button className={"hover:rotate-360 duration-500 transform transition-all"} onClick={() => fetchPage(prevPage)}><FontAwesomeIcon icon={faCircleArrowLeft}
                                                                                        size={"3x"}/></button>}
                    {nextPage &&
                        <button className={"hover:rotate-360 duration-500 transform transition-all"} onClick={() => fetchPage(nextPage)}><FontAwesomeIcon icon={faCircleArrowRight}
                                                                                        size={"3x"}/></button>}
                </div>
